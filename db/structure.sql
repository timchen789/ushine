...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_company_email CHECK (((email)::text ~* '^[^@]+@ucast\.com'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20170319014620');

INSERT INTO schema_migrations (version) VALUES ('20170319122025');

INSERT INTO schema_migrations (version) VALUES ('20170319135008');

INSERT INTO schema_migrations (version) VALUES ('20170320035754');
